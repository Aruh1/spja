...
|  18   | `btnSimpan`       | Name<br>Text  | btnSimpan<br>Simpan                                                              |
|  19   | `btnHapus`        | Name<br>Text  | btnHapus<br>Hapus                                                                |
|  20   | `btnBatal`        | Name<br>Text  | btnBatal<br>Batal                                                                |
|  21   | `btnClose`        | Name<br>Text  | btnClose<br>Close                                                                |
|  22   | `btnProgress`     | Name<br>Text  | btnProgress<br>Hitung Progress                                                   |
|  23   | `lblProgress`     | Name<br>Text  | lblProgress<br>Progress: -                                                       |
|  24   | `btnInfo`         | Name<br>Text  | btnInfo<br>Tampilkan Info                                                        |
|  25   | `lblInfo`         | Name<br>Text  | lblInfo<br>Pilih anime dari tabel, lalu klik Tampilkan Info.                     |
|  26   | `tableAnime`      | Name<br>Model | tableAnime<br>[Judul, Genre, Tahun, Status, Studio, Episode, Musim, Hari Tayang] |
...
|  17   | `btnSimpan`       | Name<br>Text  | btnSimpan<br>Simpan                                                            |
|  18   | `btnHapus`        | Name<br>Text  | btnHapus<br>Hapus                                                              |
|  19   | `btnBatal`        | Name<br>Text  | btnBatal<br>Batal                                                              |
|  20   | `btnClose`        | Name<br>Text  | btnClose<br>Close                                                              |
|  21   | `btnInfo`         | Name<br>Text  | btnInfo<br>Tampilkan Info                                                      |
|  22   | `lblInfo`         | Name<br>Text  | lblInfo<br>Pilih film dari tabel, lalu klik Tampilkan Info.                    |
|  23   | `tableFilm`       | Name<br>Model | tableFilm<br>[Judul, Genre, Tahun, Status, Durasi, Tanggal Rilis, Distributor] |
...
| + GUI_Anime()<br>- initComponents() : void<br>- addFormField(panel: JPanel, gbc: GridBagConstraints, label: String, row: int) : JTextField<br>- tambahAnime() : void<br>- clearFields() : void<br>- simpanData() : void<br>- hapusAnime() : void<br>- hitungProgress() : void<br>- tampilkanInfo() : void<br>+ main(args: String[]) : void                                                                                                    |
...
| + GUI_AnimeFilm()<br>- initComponents() : void<br>- addFormField(panel: JPanel, gbc: GridBagConstraints, label: String, row: int) : JTextField<br>- updateStatusTayang() : void<br>- tambahFilm() : void<br>- clearFields() : void<br>- simpanData() : void<br>- hapusFilm() : void<br>- tampilkanInfo() : void<br>+ main(args: String[]) : void                                                                                                    |
