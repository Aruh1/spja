...
|  No   | Nama Komponen | Properti               | Value                                                                                                |
| :---: | :------------ | :--------------------- | :--------------------------------------------------------------------------------------------------- |
|   1   | `JFrame`      | Title                  | SPJA — Sistem Penjadwalan Tayang Anime                                                               |
|   2   | `JLabel1`     | Text                   | Menu Program                                                                                         |
|   3   | `jMenuBar1`   | jMenu<br><br>jMenuItem | [1] = Home<br>[2] = Menu<br><br>[1] = Keluar<br>[2] = Kelola Anime Series<br>[3] = Kelola Anime Film |
